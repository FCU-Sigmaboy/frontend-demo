<template>
  <div class="transaction-card" @click="closeReportMenu">
    ...
    <Transition name="menu-fade">
      <div v-if="showReportMenu" class="context-menu" :style="reportMenuStyle" @click.stop>
    ...
    <div class="section">
      ...
      <div class="description-wrapper">
        <p class="description">
          ...
          <span v-if="shouldTruncate && !isExpanded" class="expand-trigger" @click="toggleExpand"
            >...展開更多</span
          >
          <span v-if="shouldTruncate && isExpanded" class="expand-trigger" @click="toggleExpand">
            顯示更少</span
    ...
    <!-- Action Buttons -->
    <div class="actions">
      <button v-if="!isOwner" class="btn-primary" :disabled="!listingStatus" @click="handleMessage">
...
<script setup>
  ...
  const handleMessage = async () => {
    ...
    try {
      ...
      const conversation = await createOrGetConversation(props.sellerId, props.productId)

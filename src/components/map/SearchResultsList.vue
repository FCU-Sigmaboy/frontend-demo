<template>
  ...
  <Transition name="slide-up">
    <div
      ...
      :class="{ 'has-results': sellers.length > 0, collapsed: !show }"
    >
      ...
      <div
        v-if="subCategoryFilters && subCategoryFilters.length > 0"
        v-show="show"
      ...
      <div ref="resultsContentRef" v-show="show" class="results-content">
        ...
        >
          ...
          <div class="seller-header" @click="toggleSellerItems(seller)">
            ...
            <i
              :class="isSellerExpanded(seller.user_id) ? 'bi bi-chevron-up' : 'bi bi-chevron-down'"
            ></i>
          </div>
            ...
            >
              ...
              <div class="item-info">
                ...
                <div class="item-price">
                  {{ new Intl.NumberFormat('zh-TW').format(item.price) }}點
                </div>
              </div>
            </div>
          </div>

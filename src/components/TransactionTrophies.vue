    ...
    <div class="trophies-row-container">
      <div class="trophies-row" :class="{ expanded: isExpanded }">
        <div
          ...
          :class="[
            'trophy-item',
            { unlocked: trophy.unlocked, current: index === currentTrophyIndex },
          ]"
        ...
        <!-- Expand Indicator -->
        <div v-if="!isExpanded && trophies.length > 1" class="expand-indicator" @click="expandRow">
        ...
        <div class="modal-body">
          <div class="trophies-grid">
            <div
              ...
              :class="[
                'trophy-grid-item',
                { unlocked: trophy.unlocked, selected: selectedTrophies.includes(trophy.id) },
              ]"
            ...
            >
              ...
              <span class="trophy-label">{{ trophy.label }}</span>
              <span v-if="!trophy.unlocked && showThreshold" class="trophy-requirement">{{
                trophy.threshold
              }}</span>

            ...
            <div v-else class="items-list">
              ...
              <TransitionGroup name="item-list" tag="div">
                <div
                  ...
                  :key="item.id"
                  class="item-card"
                  :class="{ selected: selectedItemId === item.id, disabled: !isItemAvailable(item) }"
                ...
                <div class="item-details">
                  ...
                  <div class="item-meta">
                    ...
                    <span v-else-if="item.status" class="item-status" :class="getStatusClass(item.status)">
...
function confirmTransaction() {
  ...
  const selectedItem = props.conversationItems.find(

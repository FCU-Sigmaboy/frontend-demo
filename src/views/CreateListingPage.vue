        ...
        <div v-else class="form-card">
          <form @submit.prevent="handleSubmit">
            ...
            <div class="form-section">
              <label class="section-label"> 商品照片 <span class="required">*</span> </label>
              <p class="section-hint">
                最多上傳 8 張照片，可以拖動照片到第一張做為封面照片。支援拖曳上傳
              </p>
                ...
                <div class="image-upload-grid">
                  ...
                  >
                    ...
                    >
                      ...
                      <span class="visually-hidden"> 調整第 {{ index + 1 }} 張照片 </span>
                    </button>
                  </div>
            ...
            <!-- Price Field -->
            <div class="form-section">
              <label for="price" class="form-label"> 點數 <span class="required">*</span> </label>
            ...
            <!-- Condition Field -->
            <div class="form-section">
              <label class="form-label"> 商品狀況 <span class="required">*</span> </label>
            ...
            <!-- Location Field -->
            <div class="form-section">
              <label class="form-label"> 交易地點 <span class="required">*</span> </label>
...
<script setup>
  ...
  const breadcrumbItems = computed(() => {
    if (isEdit.value) {
      return [{ label: '我的刊登', to: { name: 'ManageListings' } }, { label: '編輯刊登' }]
    }
    return [{ label: '刊登物品' }]
  })
  ...
  const fetchCategories = async () => {
    try {
      ...
      const { data, error } = await supabase.from('sub_categories').select('id, name').order('id')
  ...
  const loadItemData = async () => {
    ...
    try {
      ...
      formData.value = {
        ...
        usePrimaryLocation:
          item.use_primary_location !== undefined ? item.use_primary_location : true,
      }
  ...
  const handleDragLeave = (event) => {
    ...
    if (
      event.target.classList.contains('image-upload-dropzone') &&
...
<style scoped lang="scss">
  ...
  .image-item {
    ...
    &.is-analyzing {
      ...
      box-shadow:
        0 0 0 4px rgba(111, 184, 165, 0.2),

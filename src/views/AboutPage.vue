          ...
          <BRow class="value-cards">
            <BCol cols="12" md="4" class="mb-4">
              <div class="value-card">
                ...
                <h3>n的 PIN 碼機制</h3>
                <p>雙方取得交易共識後，現場面交時，必須輸入賣方提供的 PIN 碼，完成全部流程。系統將立即撥付點數至賣家帳戶，保障每筆交易安全無虞。</p>
              </div>
            </BCol>
            <BCol cols="12" md="4" class="mb-4">
              <div class="value-card">
                ...
                <h3>環保永續</h3>
                <p>我們深信世上沒有廢棄物，只有放錯位置的資源。透過交換賦予閒置物品第二生命，不僅能延長產品週期，也能減少碳排放。</p>
              </div>
            </BCol>
            <BCol cols="12" md="4" class="mb-4">
              <div class="value-card">
                ...
                <h3>友善社區</h3>
                <p>我們致力於打破都市冷漠，透過二手交易，重拾鄰里間的信任與溫度。每一次的面交不僅是物品的傳遞，更是連結在地情感、建立互助生活圈的溫暖契機。</p>
              </div>
            </BCol>
          </BRow>
        </section>

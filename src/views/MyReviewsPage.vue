  ...
  <div class="my-reviews-page">
    ...
    <main class="main-content">
      <div class="reviews-container">
        <!-- Breadcrumb -->
        <Breadcrumb
          :items="[{ label: '個人檔案', to: { name: 'UserProfile' } }, { label: '我的評價' }]"
        />
        ...
        <div v-else-if="reviews.length > 0">
            ...
            <div v-for="review in paginatedReviews" :key="review.id" class="review-card">
              ...
              <div v-if="review.transaction" class="transaction-info">
                <div
                  ...
                  @click="goToProductDetail(review.transaction.id)"
                >
                  <img
          ...
          <div v-if="filteredReviews.length > itemsPerPage" class="pagination-container">
            <div class="pagination-info">
              ...
              {{ Math.min(currentPage * itemsPerPage, filteredReviews.length) }} 項，共
              {{ filteredReviews.length }} 項
            </div>

  ...
  <div class="manage-listings-page">
    ...
    <main class="main-content">
      ...
      <div class="manage-container">
              ...
              <tr v-for="listing in filteredListings" :key="listing.id" class="listing-row">
                ...
                <td class="col-image">
                  <div class="product-info">
                    ...
                    <div
                      class="product-name"
                      @click="router.push({ name: 'ItemDetail', params: { id: listing.id } })"
        ...
        <div
          v-if="!isLoading && allFilteredListings.length > 5"
          class="pagination-container desktop-view"
        >
          <div class="pagination-info">
            顯示第 {{ (currentPage - 1) * itemsPerPage + 1 }} -
            {{ Math.min(currentPage * itemsPerPage, allFilteredListings.length) }} 項,共
            {{ allFilteredListings.length }} 項
          </div>
        ...
        <div class="cards-container mobile-view">
            ...
            <div v-for="i in 5" :key="`skeleton-card-${i}`" class="listing-card skeleton-card">
              ...
              <div class="card-content">
                ...
                <div class="card-details">
                  <div
                    class="skeleton-text"
                    style="width: 60%; height: 14px; margin-bottom: 8px"
                  ></div>
          ...
          <div
            v-else
            v-for="listing in mobileSortedListings.length > 0
              ? mobileSortedListings
              : filteredListings"
            :key="`card-${listing.id}`"
            class="listing-card"
          >
        ...
        <div
          v-if="!isLoading && allFilteredListings.length > 5"
          class="pagination-container mobile-view"
        >
          ...
          <div class="pagination-controls-mobile">
            <button class="pagination-btn-mobile" :disabled="currentPage === 1" @click="prevPage">
              <i class="bi bi-chevron-left"></i>
            </button>

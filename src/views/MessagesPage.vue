    ...
    <main class="main-content">
      <div class="messages-container">
        <div class="messages-layout">
          ...
          <!-- Chat Area -->
          <div
            :class="['chat-area', { 'mobile-visible': selectedConversation || messagesLoading }]"
          >
                  ...
                  <div v-if="pendingItemReference" class="pending-item-reference">
                    <div class="reference-info">
                      ...
                      <div class="reference-details">
                        ...
                        <span v-if="pendingItemPrice" class="reference-meta"
                          >{{ pendingItemPrice }}點</span
                        >
                      </div>
                    </div>
                        ...
                        <span class="reference-label">
                          ...
                          {{
                            replyingToMessage.isSent
                              ? '自己'
                              : selectedConversation?.user?.name || '對方'
                          }}
                        </span>
                        <span class="reference-text text-truncate">{{
              ...
              <div class="input-area-wrapper">
                <div class="input-area">
                  <button
                    ...
                    @click="handleOpenTransactionModal"
                    title="發起交易"
                  >

    ...
    <main class="main-content">
      ...
      <div class="favorites-container">
        ...
        <div class="page-header">
          ...
          <div class="header-actions">
            <button v-if="favoritesStore.count > 0" class="edit-btn" @click="toggleEditMode">
      ...
      <div class="favorites-container">
        ...
        <section v-else-if="displayedFavorites.length > 0" class="favorites-section">
          <TransitionGroup name="favorite-list" tag="div" class="favorites-grid">
            <div
              v-for="product in displayedFavorites"
              :key="product.item_id"
              :class="[
                'favorite-item',
                { 'edit-mode': isEditMode, selected: isSelected(product.item_id) },
              ]"
            >
              ...
              <div
                ...
                @click="toggleSelection(product.item_id)"
              ></div>

<template>
  <div class="my-followers-page">
    ...
    <main class="main-content">
      <!-- Breadcrumb -->
      <Breadcrumb
        :items="[{ label: '我的檔案', to: { name: 'UserProfile' } }, { label: '我的追蹤' }]"
      />
      ...
      <div class="followers-container">
        ...
        <TransitionGroup
          ...
          class="users-list"
        >
          <div v-for="user in displayedUsers" :key="user.user_id" class="user-card">
...
<script setup>
  ...
  import { getMyFollowers, getMyFollowing, followUser, unfollowUser } from '@/api/followAPI'

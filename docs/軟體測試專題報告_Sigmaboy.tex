...
% IMPORTANT: Must consume ALL arguments to prevent them from spilling into document body
% IMPORTANT: Must be \long to allow \par in arguments (common in code blocks)
\makeatletter
\long\def\NewStructureName#1{\@bsphack\@esphack}
\long\def\AssignStructureRole#1#2{\@bsphack\@esphack}
\long\def\NewTaggingSocket#1#2{\@bsphack\@esphack}
\long\def\NewTaggingSocketPlug#1#2#3{\@bsphack\@esphack} % Fix: Consumes 3 args & allows par
\long\def\AssignTaggingSocketPlug#1#2{\@bsphack\@esphack}

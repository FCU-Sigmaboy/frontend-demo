...
describe.sequential('get_my_reviews', () => {
  ...
  describe('getMyReviews', () => {
    it('should fetch my reviews with default parameters', async () => {
    ...
    it('should fetch my reviews with custom parameters', async () => {
      supabase.rpc.mockResolvedValueOnce({ 
        data: mockReviews, 
        error: null 
      })
    ...
    it('should throw error when RPC call fails', async () => {
      ...
      await expect(getMyReviews()).rejects.toThrow('RPC 呼叫失敗')
    })
  })
})
